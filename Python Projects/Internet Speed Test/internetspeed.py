...
lab = Label(sp, text="Internet Speed Test", font=("Time New Roman", 30, "bold"), bg="#46336A", fg="#1EF7DA")
...
button = Button(sp, text="Test Speed", font=("Time New Roman", 30, "bold"), relief=RAISED, bg="Green", command=speedcheck)
